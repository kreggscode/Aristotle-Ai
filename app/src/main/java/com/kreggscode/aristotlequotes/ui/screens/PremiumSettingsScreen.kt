                    ...
                    onShareClick = {
                        try {
                            val shareIntent = Intent(Intent.ACTION_SEND).apply {
                                type = "text/plain"
                                putExtra(Intent.EXTRA_SUBJECT, "Aristotle - Insights & Wisdom")
                                putExtra(Intent.EXTRA_TEXT, "Check out Aristotle - Insights & Wisdom app! Get inspired by Aristotle's wisdom daily.\n\nhttps://play.google.com/store/apps/details?id=com.kreggscode.aristotlequotes")
                            }
                ...
                RateAppSection(
                    onRateClick = {
                        try {
                            ...
                            val playStoreIntent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.kreggscode.aristotlequotes"))
                            playStoreIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                            context.startActivity(playStoreIntent)
                        } catch (e: Exception) {
                            // If Play Store app is not available, open in browser
                            try {
                                val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.kreggscode.aristotlequotes"))
        ...
        Row(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(
                        "Share Aristotle wisdom with friends",
                        style = MaterialTheme.typography.bodySmall,
                        color = PremiumColors.CyberBlue
                    )
                }
                    ...
                    onClick = {
                        try {
                            val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                                ...
                                putExtra(Intent.EXTRA_SUBJECT, "Aristotle App Feedback")
                            }
        ...
        Column(
            ...
            SettingRow(
                ...
                onClick = {
                    val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                        data = Uri.parse("mailto:kreg9da@gmail.com")
                        putExtra(Intent.EXTRA_SUBJECT, "Aristotle App - Bug Report")
            ...
            SettingRow(
                ...
                onClick = {
                    val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                        data = Uri.parse("mailto:kreg9da@gmail.com")
                        putExtra(Intent.EXTRA_SUBJECT, "Aristotle App - Support Request")
                    }
                    context.startActivity(emailIntent)
                }
            )
