...
import com.kreggscode.aristotlequotes.model.Quote
import com.kreggscode.aristotlequotes.ui.components.*
import com.kreggscode.aristotlequotes.ui.theme.*
import com.kreggscode.aristotlequotes.viewmodel.QuoteViewModel
        ...
        Column(
            ...
            Text(
                text = "This quote from \"${quote.Work}\" was written during ${quote.Year}, " +
                        "a period when Aristotle was ${getHistoricalContext(quote.Year)}. " +
...
fun getAIInsight(quote: Quote): String {
    val insights = listOf(
        "This quote reflects Aristotle's belief that ${quote.Category.lowercase()} is fundamental to human progress. The emphasis on ${quote.Quote.split(" ").take(3).joinToString(" ")} suggests a deep understanding of how innovation emerges from questioning established norms.",
        "Aristotle's perspective here challenges us to reconsider our approach to ${quote.Category.lowercase()}. Written in ${quote.Year}, this wisdom remains remarkably relevant to modern challenges in science and society.",
        "The philosophical depth in this quote demonstrates Aristotle's role not just as a scientist, but as a thinker who understood the interconnection between ${quote.Category.lowercase()} and human experience.",
        "This insight from ${quote.Work} showcases Aristotle's unique ability to distill complex ideas into accessible wisdom. The focus on ${quote.Category.lowercase()} reveals his holistic approach to understanding reality."
    )
...
fun generateReflectionPrompts(quote: Quote): List<String> {
    return listOf(
        ...
        "How might Aristotle's perspective change your approach to problem-solving?",
