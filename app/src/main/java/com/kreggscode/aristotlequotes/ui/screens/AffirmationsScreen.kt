...
fun AffirmationsScreen(
    ...
    val affirmations = remember { generateAristotleAffirmations() }
    ...
    Box(
        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                item {
                    Text(
                        "🌟 Aristotle-Inspired Affirmations",
...
fun BreathingExerciseCard() {
    ...
    GlassmorphicCard(
        ...
        Column(
            ...
            Text(
                "Take a moment to center yourself with Aristotle's wisdom",
...
fun generateAristotleAffirmations(): List<Affirmation> {
    return listOf(
        Affirmation(
            1,
        ...
        Affirmation(
            2,
            "Like Aristotle, I question everything and seek deeper understanding.",
            "Wisdom",
            "🤔",
